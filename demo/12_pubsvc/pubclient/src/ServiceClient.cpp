...
DEF_LOG_SCOPE(demo_12_pubclient_ServiceClient_serviceConnected);
DEF_LOG_SCOPE(demo_12_pubclient_ServiceClient_broadcastReachedMaximum);
DEF_LOG_SCOPE(demo_12_pubclient_ServiceClient_responseHelloWorld);
DEF_LOG_SCOPE(demo_12_pubclient_ServiceClient_processTimer);
...
{
    LOG_SCOPE( demo_12_pubclient_ServiceClient_serviceConnected );
...
{
    LOG_SCOPE(demo_12_pubclient_ServiceClient_responseHelloWorld);
...
{
    LOG_SCOPE(demo_12_pubclient_ServiceClient_broadcastReachedMaximum);
...
{
    LOG_SCOPE(demo_12_pubclient_ServiceClient_processTimer);
    ASSERT(&timer == &mTimer);
