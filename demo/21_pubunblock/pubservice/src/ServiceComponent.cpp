...
DEF_LOG_SCOPE( demo_21_pubservice_ServiceComponent_startupServiceInterface );
DEF_LOG_SCOPE( demo_21_pubservice_ServiceComponent_requestIdentifier );
DEF_LOG_SCOPE( demo_21_pubservice_ServiceComponent_requestHelloUblock );
DEF_LOG_SCOPE( demo_21_pubservice_ServiceComponent_processTimer );
...
{
    LOG_SCOPE( demo_21_pubservice_ServiceComponent_startupServiceInterface );
...
{
    LOG_SCOPE( demo_21_pubservice_ServiceComponent_requestIdentifier );
...
{
    LOG_SCOPE( demo_21_pubservice_ServiceComponent_requestHelloUblock );
...
{
    LOG_SCOPE( demo_21_pubservice_ServiceComponent_processTimer );
