...
DEF_LOG_SCOPE( demo_21_pubservice_ServiceClient_serviceConnected );
DEF_LOG_SCOPE( demo_21_pubservice_ServiceClient_responseIdentifier );
DEF_LOG_SCOPE( demo_21_pubservice_ServiceClient_responseHelloUnblock );
DEF_LOG_SCOPE( demo_21_pubservice_ServiceClient_requestHelloUblockFailed );
DEF_LOG_SCOPE( demo_21_pubservice_ServiceClient_onHelloServiceStateUpdate );
DEF_LOG_SCOPE( demo_21_pubservice_ServiceClient_processTimer );
...
{
    LOG_SCOPE( demo_21_pubservice_ServiceClient_serviceConnected );
...
{
    LOG_SCOPE( demo_21_pubservice_ServiceClient_responseIdentifier );
...
{
    LOG_SCOPE( demo_21_pubservice_ServiceClient_responseHelloUnblock );
...
{
    LOG_SCOPE( demo_21_pubservice_ServiceClient_requestHelloUblockFailed );
...
{
    LOG_SCOPE( demo_21_pubservice_ServiceClient_onHelloServiceStateUpdate );
...
{
    LOG_SCOPE( demo_21_pubservice_ServiceClient_processTimer );
