...
DEF_LOG_SCOPE(demo_23_pubsubmix_common_Subscriber_serviceConnected);
DEF_LOG_SCOPE(demo_23_pubsubmix_common_Subscriber_onStringOnChangeUpdate);
DEF_LOG_SCOPE(demo_23_pubsubmix_common_Subscriber_onIntegerAlwaysUpdate);
DEF_LOG_SCOPE(demo_23_pubsubmix_common_Subscriber_onServiceProviderStateUpdate);
...
{
    LOG_SCOPE(demo_23_pubsubmix_common_Subscriber_serviceConnected);
...
{
    LOG_SCOPE(demo_23_pubsubmix_common_Subscriber_onStringOnChangeUpdate);
    Console & console = Console::getInstance();
    console.lockConsole();
    console.saveCursorPosition();
...
{
    LOG_SCOPE(demo_23_pubsubmix_common_Subscriber_onIntegerAlwaysUpdate);
    Console & console = Console::getInstance();
    console.lockConsole();
...
{
    LOG_SCOPE(demo_23_pubsubmix_common_Subscriber_onServiceProviderStateUpdate);
    if (state == NEService::eDataStateType::DataIsOK)
    {
