...
DEF_LOG_SCOPE(demo_23_pubsubmix_common_Publisher_clientConnected);
DEF_LOG_SCOPE(demo_23_pubsubmix_common_Publisher_start);
DEF_LOG_SCOPE(demo_23_pubsubmix_common_Publisher_stop);
DEF_LOG_SCOPE(demo_23_pubsubmix_common_Publisher_invalidate);
DEF_LOG_SCOPE(demo_23_pubsubmix_common_Publisher_quit);
DEF_LOG_SCOPE(demo_23_pubsubmix_common_Publisher_processTimer);
...
{
    LOG_SCOPE(demo_23_pubsubmix_common_Publisher_clientConnected);
...
{
    LOG_SCOPE(demo_23_pubsubmix_common_Publisher_start);
...
{
    LOG_SCOPE(demo_23_pubsubmix_common_Publisher_stop);
...
{
    LOG_SCOPE(demo_23_pubsubmix_common_Publisher_invalidate);
...
{
    LOG_SCOPE(demo_23_pubsubmix_common_Publisher_quit);
...
{
    LOG_SCOPE(demo_23_pubsubmix_common_Publisher_processTimer);
