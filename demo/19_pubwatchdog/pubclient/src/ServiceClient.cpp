...
DEF_LOG_SCOPE(demo_19_pubclient_ServiceClient_serviceConnected);
DEF_LOG_SCOPE(demo_19_pubclient_ServiceClient_onServiceStateUpdate);
DEF_LOG_SCOPE(demo_19_pubclient_ServiceClient_responseStartSleep);
DEF_LOG_SCOPE(demo_19_pubclient_ServiceClient_requestStartSleepFailed );
DEF_LOG_SCOPE(demo_19_pubclient_ServiceClient_requestStopServiceFailed);
DEF_LOG_SCOPE(demo_19_pubclient_ServiceClient_requestShutdownServiceFailed);
...
{
    LOG_SCOPE(demo_19_pubclient_ServiceClient_serviceConnected);
...
{
    LOG_SCOPE(demo_19_pubclient_ServiceClient_onServiceStateUpdate);
...
{
    LOG_SCOPE(demo_19_pubclient_ServiceClient_responseStartSleep);
...
{
    LOG_SCOPE( demo_19_pubclient_ServiceClient_requestStartSleepFailed );
...
{
    LOG_SCOPE( demo_19_pubclient_ServiceClient_requestStopServiceFailed );
...
{
    LOG_SCOPE( demo_19_pubclient_ServiceClient_requestShutdownServiceFailed );
