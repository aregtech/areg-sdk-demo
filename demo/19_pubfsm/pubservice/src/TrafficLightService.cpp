...
TrafficLightService::TrafficLightService(const NERegistry::ComponentEntry & entry, ComponentThread & owner)
    ...
    , PowerManagerStub              ( static_cast<Component &>(*this) )
    , TrafficControllerStub         ( static_cast<Component &>(*this) )
    , IETrafficLightActionHandler   ( )

    , mConsoleInput                 ( entry.mRoleName, static_cast<Component &>(*this) )
    , mLightFsm                     ( static_cast<IETrafficLightActionHandler &>(*this) )
{
