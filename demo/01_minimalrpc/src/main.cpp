...
#include "demo/01_minimalrpc/services/HelloServiceStub.hpp"
#include "demo/01_minimalrpc/services/HelloServiceClientBase.hpp"
...
public:
    ServiceProvider(const NERegistry::ComponentEntry& entry, ComponentThread& owner)
        ...
        , HelloServiceStub(static_cast<Component&>(*this))
    {   }
...
BEGIN_MODEL(_modelName)
    ...
    BEGIN_REGISTER_THREAD( "Thread2", AREG_THREAD_STACK_SIZE_DEFAULT )
